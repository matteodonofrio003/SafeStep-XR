...
using Youbiquo.LeonardoXR.Core.Interactions.Utils;
using Youbiquo.LeonardoXR.Core.Interactions;
...
namespace Youbiquo.LeonardoXR.Samples.UI
{
    /// <summary>
    ...
    /// </remarks>
    [AddComponentMenu("XR/LeonardoXR Hand Menu", 22)]
    public class LeonardoXRHandMenu : MonoBehaviour
    {
        /// <summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        XRInteractionManagerExtension m_InteractionManager;
        ...
        /// </summary>
        /// <seealso cref="XRInteractionManagerExtension.IsHandSelecting"/>
        public XRInteractionManagerExtension interactionManager
        {
        ...
        LeonardoXRInputModalityManager.InputMode m_CurrentInputMode = LeonardoXRInputModalityManager.InputMode.None;
        ...
        protected void OnEnable()
        {
            ...
            m_BindingsGroup.AddBinding(LeonardoXRInputModalityManager.currentInputMode.SubscribeAndUpdate(OnInputModeChanged));
        ...
        void OnInputModeChanged(LeonardoXRInputModalityManager.InputMode newInputMode)
        {
        ...
        {
            if (m_CurrentInputMode == LeonardoXRInputModalityManager.InputMode.MotionController)
        ...
        {
            if (m_CurrentInputMode == LeonardoXRInputModalityManager.InputMode.None)
            {
                m_MenuVisibleBindableVariable.Value = false;
                return;
            }
        ...
        bool TryGetInteractionManager(out XRInteractionManagerExtension manager)
        {
            ...
            if (ComponentFinder<XRInteractionManagerExtension>.TryFindComponent(out m_InteractionManager))
            {
                manager = m_InteractionManager;
                return true;
            }
